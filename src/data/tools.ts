...
export const tools: Tool[] = [
  ...
  {
    id: 'element-metadata',
    name: 'Element Metadata Overlay',
    description: 'Inspect element styles on hover (Cmd+Shift+.)',
    category: 'frontend',
  ...
  {
    id: 'live-css-scratchpad',
    name: 'Live CSS Scratchpad',
    description: 'Inject temporary CSS per domain',
    category: 'frontend',
    icon: `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
